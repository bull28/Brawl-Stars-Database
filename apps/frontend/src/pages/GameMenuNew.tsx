                ...
                <Flex w={"100%"} flexDir={"column"} gap={5} alignItems={"center"}>
                    {loggedIn === true ?
                        ...
                        <Flex flexDir={"column"} alignItems={"center"} fontSize={"lg"} gap={1}>
                            <Button minW={["50%", "20em"]} bgColor={"gray.800"} _hover={{"backgroundColor": "gray.600"}} fontSize={"inherit"} onClick={() => window.location.href = `${api}/bullgame`}>Play Difficulties 1 - 6</Button>
                            <Button minW={["50%", "20em"]} bgColor={"gray.800"} _hover={{"backgroundColor": "gray.600"}} fontSize={"inherit"} onClick={() => window.location.href = `${api}/bullgame?bull=expert`}>Play Difficulties 7 - 10</Button>
