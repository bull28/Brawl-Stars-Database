...
const badgeList = [
    ...
    {name: "shade", category: "player", index: 9, coins: [0, 0]},
    {name: "mandy", category: "player", index: 10, coins: [0, 0]},
    {name: "hank", category: "player", index: 11, coins: [0, 0]},
...
export function validateReport(report: GameReport): number{
    ...
    if (gameMode === 0){
        ...
        const maxUpgrades = difficulty >= 6 ? [20, 14, 8, 8, 8, 8, 7, 5] : [16, 10, 6, 6, 6, 6, 5, 4];
