        ...
        <Flex flexDir={'column'} w={'100%'} justifyContent={'center'} alignItems={'center'} textAlign={'center'}>
            ...
            {localStorage.getItem('username') && 
                <Flex my={10} justifyContent={'center'}>
                    ...
                    <Flex justifyContent={'center'} textAlign={'center'} alignItems={'center'} p={3} borderRadius={'lg'} flexDir={'column'}>
                        ...
                        <Flex animation={(data?.avatarColor === 'rainbow') ? `${RainbowBorder()} 12s infinite` : ''} bgColor={(data?.avatarColor === 'rainbow') ? 'black' : data?.avatarColor} flexDir={'column'} p={10}  border={'3px solid black'} mb={5}>
                            {(data?.collectionScore !== 'S+') ?
                                <Text color={'white'} className={'heading-2xl'} fontSize={'2xl'}>{data?.collectionScore}</Text>
                                :
                            ...
                            <VStack spacing={1}>                          
                                <Text color={'white'} className={'heading-md'}  fontSize={'md'}>Brawlers Unlocked: </Text>
                                ...
                                <Text color={'white'} className={'heading-md'} fontSize={'md'}>Unique Pins Unlocked:  </Text>
                                ...
                                <Text color={'white'} className={'heading-md'} fontSize={'md'}>Completed Brawlers:  </Text>
                                ...
                                <Text color={'white'} className={'heading-md'} fontSize={'md'}>Total Pins: </Text>
                                {(data?.unlockedPins !== data?.totalPins) ?
                    ...
                    <Flex flexDir={'column'}>
                        <Text color={'white'} className={'heading-2xl'} fontSize={'2xl'} mb={3}>Brawl Boxes</Text>
                    ...
                    <Flex flexDir={'column'}>
                        <Text color={'white'} className={'heading-2xl'} fontSize={'2xl'} mb={3}>Tokens</Text>                    
