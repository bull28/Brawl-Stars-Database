...
export default function SkullBackground() {
    ...
    return (
        <Flex pos={'absolute'} overflow={'hidden'} zIndex={'-1'} top={0} w={'100%'} h={'100%'}>                        
            ...
            <Flex w={'100%'} h={'100%'} backgroundRepeat={'no-repeat'} objectFit={'cover'} backgroundAttachment={'fixed'} backgroundImage={require(`../assets/backgrounds/background_${backgroundName}.webp`)}/>    
        </Flex>
